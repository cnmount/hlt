...
import OrderDetailForCard from "../components/OrderDetailForCard";
...
const Cart = () => {
 ...
 <button className={styles.clearButton} onClick={() => dispatch(reset())}>
      ...
      {card && cardOpen && <OrderDetailForCard total={cart.total} createOrder={createOrder} setCardOpen={setCashOpen} />}
    </div>
  );
};
